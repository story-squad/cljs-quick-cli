...
> from [create-reagent-app](https://www.npmjs.com/package/create-reagent-app).
...
- [cljs-http](https://clojars.org/cljs-http) (for sending requests to the API)

- [syn-antd](https://clojars.org/syn-antd) (A Shadow-CLJS friendly Reagent wrapper around Ant Design components.)
...
### (optional) Calva
> Note: if you're using VS Code, install [Calva](https://calva.io/)
